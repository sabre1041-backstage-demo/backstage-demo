...
Fork the following repo https://github.com/sabre1041-backstage-demo/backstage-demo to your organization.
...
cd backstage-demo
find . -type f -not -path '*/\.git/*' -exec sed -i "s/sabre1041-backstage-demo/${github_organization}/g" {} +
find . -type f -not -path '*/\.git/*' -exec sed -i "s/sabre1041-backstage-demo/${github_organization}/g" {} +
find . -type f -not -path '*/\.git/*' -exec sed -i "s/cluster-sxjwp.sxjwp.sandbox1298.opentlc.com/${base_domain}/g" {} +
git add -A
...
Fork the following repo https://github.com/sabre1041-backstage-demo/shared-workflows to your organization.
Then execute the following commands
...
Fork the following repo https://github.com/sabre1041-backstage-demo/software-templates to your organization.
Then execute the following commands
...
Fork the following repo https://github.com/sabre1041-backstage-demo/backstage-app-demo to your organization.
